...
(function ($) {
        ...
        function addCards(team){
            team.forEach((member) => {
                ...
                div.innerHTML = div.innerHTML
                    ...
                    .replace(/{DIVISION}/g,  member.position || member.division || member.team )
    ...
    // replace HR with Human Resources
        ...
        // display admins
        var CEO = data.filter(m => m.position?.includes("CEO") || m.team?.includes("CEO") || m.division?.includes("CEO"))
        addCards(CEO)
    
        var CFO = data.filter(m => m.position?.includes("Chief Operating Officer") || m.team?.includes("Chief Operating Officer") || m.division?.includes("Chief Operating Officer"));
        addCards(CFO)
